...
interface IRamsesV2Factory {
    ...
    /// @param _newFeeSetter the new fee setter's address
    function setFeeSetter(address _newFeeSetter) external;

    /// @notice Sets a new fee for a specific CL pool
    /// @param _pool the pool's address
    /// @param _fee the new fee (0.0001%) = 1, 10% MAX
